...
function crouch() {
    ...
    patatinaY += 30; // Abbassa la patatina
    ...
    setTimeout(() => {
        ...
        patatinaY -= 30; // Riporta la patatina alla posizione originale
        document.getElementById("smashMessage").style.display = "none"; // Nasconde il messaggio
        draw();
